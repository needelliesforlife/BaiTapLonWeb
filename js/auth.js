...
function initProfileForm() {
    ...
    if (currentUser.address) {
        ...
        document.getElementById('profile-zip').value = currentUser.address.zipCode || '';
        document.getElementById('profile-country').value = currentUser.address.country || '';
    }
    ...
    profileForm.addEventListener('submit', function(e) {
        ...
        if (this.checkValidity()) {
            ...
            // Show result message
            const alertElement = document.createElement('div');
            alertElement.className = `alert alert-${result.success ? 'success' : 'danger'}`;
            alertElement.textContent = result.message;
...
function updateAuthUI() {
    ...
    const loginLinks = document.querySelectorAll('.top-nav a[href*="login.html"]');
    const registerLinks = document.querySelectorAll('.top-nav a[href*="register.html"]');
...
function initAccountPage() {
    ...
    if (accountDateElement && currentUser) {
        ...
        accountDateElement.textContent = new Date(currentUser.dateJoined).toLocaleDateString(undefined, dateOptions);
    }
}
